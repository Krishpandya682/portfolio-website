    ...
    <div className="personal_projects" id="personal_projects">
      ...
      <div class="horizontal-snap">
        ...
        <Card
          ...
          btn1={
            <object
              data="assets/google-play.svg"
              width="30"
              height="30"
            ></object>
          }
          btn2={
            <object data="assets/github.svg" width="40" height="40"></object>
          }
        ...
        <Card
          ...
          img3="ftc2"
          img4="ftc1"
          vid="sample-mp4-file.mp4"
          btn1={
            <object data="assets/website.svg" width="40" height="40"></object>
          }
          btn2={
            <object data="assets/github.svg" width="40" height="40"></object>
          }
